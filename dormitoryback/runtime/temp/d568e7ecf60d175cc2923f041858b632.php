<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:90:"D:\PHP\AppServ\www\yibanbx\dormitoryback\public/../application/admin\view\index\index.html";i:1540308115;s:80:"D:\PHP\AppServ\www\yibanbx\dormitoryback\application\admin\view\common\meta.html";i:1561468076;s:82:"D:\PHP\AppServ\www\yibanbx\dormitoryback\application\admin\view\common\header.html";i:1560151378;s:80:"D:\PHP\AppServ\www\yibanbx\dormitoryback\application\admin\view\common\menu.html";i:1541400394;s:83:"D:\PHP\AppServ\www\yibanbx\dormitoryback\application\admin\view\common\control.html";i:1526698911;s:82:"D:\PHP\AppServ\www\yibanbx\dormitoryback\application\admin\view\common\script.html";i:1561468751;}*/ ?>
<!DOCTYPE html>
...
<link rel="shortcut icon" href="/yibanbx/dormitoryback/public/assets/img/favicon.ico" />
<!-- Loading Bootstrap -->
<!-- <link href="/yibanbx/dormitoryback/public/assets/css/backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet"> -->
<link href="/yibanbx/dormitoryback/public/assets/css/backend.css?v=<?php echo \think\Config::get('site.version'); ?>" rel="stylesheet">

<!-- HTML5 shim, for IE6-8 support of HTML5 elements. All other JS at the end of file. -->
<!--[if lt IE 9]>
  <script src="/yibanbx/dormitoryback/public/assets/js/html5shiv.js"></script>
  <script src="/yibanbx/dormitoryback/public/assets/js/respond.min.js"></script>
<![endif]-->
    ...
    <div id="firstnav">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="/yibanbx/dormitoryback/public/" target="_blank"><i class="fa fa-home" style="font-size:14px;"></i></a>
                </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/yibanbx/dormitoryback/public<?php echo $admin['avatar']; ?>" class="user-image" alt="<?php echo $admin['nickname']; ?>">
                        <span class="hidden-xs"><?php echo $admin['nickname']; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="/yibanbx/dormitoryback/public<?php echo $admin['avatar']; ?>" class="img-circle" alt="">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="/yibanbx/dormitoryback/public<?php echo $admin['avatar']; ?>" class="img-circle" /></a>
        </div>
    ...
    <ul class="sidebar-menu <?php if($config['fastadmin']['multiplenav']): ?>show-submenu<?php endif; ?>">
        ...
        <li data-rel="external"><a href="https://jq.qq.com/?_wv=1027&k=487PNBb" target="_blank"><i class="fa fa-qq text-aqua"></i> <span><?php echo __('QQ qun'); ?></span></a></li> -->
            ...
            <footer class="main-footer hide">
                ...
                <strong>Copyright &copy; 2017-2018 <a href="//service.knocks.tech">长安大学易班工作站</a>.</strong> All rights reserved.
            </footer>
...
<!-- /.control-sidebar -->
        ...
        <!-- 加载JS脚本 -->
        <!-- <script src="/yibanbx/dormitoryback/public/assets/js/require<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js" data-main="/yibanbx/dormitoryback/public/assets/js/require-backend<?php echo \think\Config::get('app_debug')?'':'.min'; ?>.js?v=<?php echo $site['version']; ?>"></script> -->
<script src="/yibanbx/dormitoryback/public/assets/js/require.js" data-main="/yibanbx/dormitoryback/public/assets/js/require-backend.js?v=<?php echo $site['version']; ?>"></script>
    </body>
</html>