...
class Wxuser extends Api
{
    ...
    public function init(){
        ...
        $appid = Config::get('wechat.miniapp_wrws')["appId"];
        $appsecret = Config::get('wechat.miniapp_wrws')["appSecret"];
        $retData = [];
    ...
    public function bind(){
        ...
        if($bindInfo['status'] === true){
            ...
            if($bindStatus){
                ...
                //添加我认我生数据
                $wrwsuser=new WrwsModel;
                $wrwsuser->bind($key['stuid']);
                $this->success("绑定成功");
            }else{
                // $info = [
                //     'status' => 200,
    ...
    */
    ...
    private function checkBind($username, $password){
        ...
        //测试代码
        // if($post_data['userName']=='170049'||$post_data['userName']=='2019902509'){
        //     $return['status']=true;
        // }
